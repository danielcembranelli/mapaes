...
<img src='imagens/layout_seta.gif' width="15" height="9"><b class=font-10>Adicionar pátio</b><br>&nbsp;
</td>
</tr>
<form method='POST' action='patio.php'>
...
<?
$sql = mysql_query ("INSERT INTO patio (NOME_PATIO) VALUES ('$nome');");
if (!$sql){
...
<table border='0' width='600' cellspacing='1' cellpadding='0'>
<tr>
<td width='600'><center><font class=font-10><b class=font-vinho><br> O pátio foi adicionado com sucesso!<br><br></b>
</font></center></td>
</tr>
<script>window.setTimeout('changeurl();',2000); function changeurl(){window.location='index.php';}</script></table><? } ?>
<? } elseif($modulo==editar){?>
<?
$noticia = mysql_query("SELECT * FROM patio where ID_PATIO = '$id'");
...
<img src='imagens/layout_seta.gif' width="15" height="9"><b class=font-10>Visualizar pátio</b><br>&nbsp;
</td>
</tr>
<tr>
<td width='730' bgcolor='#FFFFFF' colspan='5'><font class=font-11><span class=font-azul><center>não existe nenhum pátio para está consulta</center></span></font></td>
</tr>
</table>
<?
}else {
...
<tr>
<td width='600' validn='middle'>
<img src='imagens/layout_seta.gif' width="15" height="9"><b class=font-10>Editar pátio</b><br>&nbsp;
</td>
</tr>
<form method='POST' action='patio.php'>
<input type='hidden' name='modulo' value='editado'>
<input type='hidden' name='id' value='<? echo $dom[ID_PATIO] ?>'>
<tr>
<td width='600'><font class=font-10><span class=font-vinho>nome:</span></font></td>
</tr>
<tr>
<td width='600'>
<input type='text' name='usuario' size='20' maxlength='30' value="<? echo $dom[NOME_PATIO] ?>" class=form-especial onblur=this.className='boxnormal' onfocus=this.className='boxover'></td>
</tr>
<tr>
<td width='600'><font class=font-10>&nbsp;</font></td>
</tr>
...
<?
$sql = mysql_query("UPDATE patio SET NOME_PATIO='$usuario' WHERE ID_PATIO='$id' LIMIT 1;");
if (!$sql){
echo "Não foi possivel a consulta.";}
else{
?>
<table border='0' width='600' cellspacing='1' cellpadding='0'>
<tr>
<td width='600'><center><font class=font-10><b class=font-vinho><br> O pátio foi atualizado com sucesso!<br><br></b>
</font></center></td>
</tr>
<script>window.setTimeout('changeurl();',2000); function changeurl(){window.location='index.php';}</script></table><? } ?>
...
<tr>
<td width='730' bgcolor='#FFFFFF' colspan='5'><font class=font-11><span class=font-azul><center>não existe nenhum usuário para está consulta</center></span></font></td>
</tr>
</table>
<?
}else {
...
<td width='560'><b class=font-12><span class=font-preto><center>Nome</center></span></b></td>
</tr>
<? while ($dom = mysql_fetch_array($noticia)){ 
$cor = ($coralternada++ %2 ? "FFFFFF" : "FFFFDC");
?>
<tr bgcolor='<? echo $cor ?>'>
<td width='30'><font class=font-11><span class=font-cinza-1><center><? echo $dom[ID_PATIO]?></center></span></font></td>
<td width='140'><center><font class=font-11><a href='?modulo=confirmadel&id=<? echo $dom[ID_PATIO]?>'><img src='imagens/layout_btexcluir.gif' width='54' height='16' border='0'></a>&nbsp;<a href='?modulo=editar&id=<? echo $dom[ID_PATIO]?>'><img src='imagens/layout_bteditar.gif' width='54' height='16' border='0'></a></font></center></td>
<td width='560'><font class=font-11><span class=font-cinza-1>&nbsp;<? echo $dom[NOME_PATIO]?></span></font></td>
</tr>
<? } ?>
...
<tr>
<td width='700'><center><font class=font-10><b class=font-vinho><br> Você tem certeza que desejá excluir este usuário?<br><br></b>
...
<?
$sql = mysql_query("DELETE FROM patio WHERE id='$id' LIMIT 1;");
if (!$sql){
echo "Não foi possivel a consulta.";}
else{
?>
