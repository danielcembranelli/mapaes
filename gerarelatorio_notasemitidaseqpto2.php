...
<body>
<p align="center"><b><font face="Verdana" size="2">Relação de Notas -  Emitidas por Equipamento (<? equipamento($obra) ?>)</font></b>
<br> 
<br> 
...
?>
    <tr>
      ...
      <td align="center"><font face="Verdana" size="2"><? data($notaNOTA_INI) ?> |<? data($notaNOTA_FIM) ?> ** <? echo $notaID_NOTA ?></font></td>
    </tr>
