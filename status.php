...
<img src='imagens/layout_seta.gif' width="15" height="9"><b class=font-10>Adicionar status</b><br>&nbsp;
</td>
</tr>
...
<tr>
<td width='600'>
<input type='text' name='letra' size='10' maxlength='5' class=form-especial onblur=this.className='boxnormal' onfocus=this.className='boxover'></td>
</tr>
<tr>
<td width='600'><font class=font-10><span class=font-vinho>ordem :</span></font></td>
</tr>
<tr>
<td width='600'>
<input type='text' name='ordem' size='10' maxlength='5' class=form-especial onblur=this.className='boxnormal' onfocus=this.className='boxover'></td>
</tr>
<tr>
<td width='600'><font class=font-10><span class=font-vinho>disponível :</span></font></td>
</tr>
<tr>
<td width='600'>
<input type="radio" value="d" checked name="ativo">disponivel <input type="radio" value="o" name="ativo">obra <input type="radio" value="m" name="ativo">manutenção <input type="radio" value="b" name="ativo">observação <input type="radio" value="v" name="ativo">venda</td>
</tr>
<tr>
...
<?
$sql = mysql_query ("INSERT INTO status (nome, letra, ativo,ordem) VALUES ('$nome','$letra','$ativo','$ordem');");
if (!$sql){
...
<table border='0' width='600' cellspacing='1' cellpadding='0'>
<tr>
<td width='600'><center><font class=font-10><b class=font-vinho><br> O status foi adicionado com sucesso!<br><br></b>
</font></center></td>
</tr>
<script>window.setTimeout('changeurl();',2000); function changeurl(){window.location='index.php';}</script></table><? } ?>
<? } elseif($modulo==editar){?>
<?
$noticia = mysql_query("SELECT * FROM status where id = '$id' order by nome");
...
<tr>
<td width='730' bgcolor='#FFFFFF' colspan='5'><font class=font-11><span class=font-azul><center>não existe nenhum status para está consulta</center></span></font></td>
</tr>
</table>
<?
}else {
...
<tr>
<td width='600' validn='middle'>
<img src='imagens/layout_seta.gif' width="15" height="9"><b class=font-10>Editar status</b><br>&nbsp;
</td>
</tr>
<form method='POST' action='status.php'>
...
<tr>
<td width='600'>
<input type='text' name='letra' size='10' maxlength='5' value="<? echo $dom[letra] ?>" class=form-especial onblur=this.className='boxnormal' onfocus=this.className='boxover'></td>
</tr>
<tr>
<td width='600'><font class=font-10><span class=font-vinho>ordem :</span></font></td>
</tr>
<tr>
<td width='600'>
<input type='text' name='ordem' size='10' maxlength='5' value="<? echo $dom[ordem] ?>" class=form-especial onblur=this.className='boxnormal' onfocus=this.className='boxover'></td>
</tr>
<tr>
<td width='600'><font class=font-10><span class=font-vinho>disponível :</span></font></td>
</tr>
<tr>
<td width='600'>
<input type="radio" value="d" <? if($dom[ativo]==d){?>checked<? } else {}?> name="ativo">disponivel <input type="radio" value="o" <? if($dom[ativo]==o){?>checked<? } else {}?> name="ativo">obra <input type="radio" value="m" <? if($dom[ativo]==m){?>checked<? } else {}?> name="ativo">manutenção <input type="radio" value="b" <? if($dom[ativo]==b){?>checked<? } else {}?> name="ativo">observação <input type="radio" value="v" <? if($dom[ativo]=='v'){?>checked<? }?> name="ativo">venda</td>
</tr>
<tr>
<td width='600'><font class=font-10>&nbsp;</font></td>
</tr>
...
$sql = mysql_query("UPDATE status SET nome='$nome', letra='$letra', ativo='$ativo', ordem='$ordem' WHERE id='$id' LIMIT 1;");
if (!$sql){
echo "Não foi possivel a consulta.";}
else{
?>
<table border='0' width='600' cellspacing='1' cellpadding='0'>
<tr>
<td width='600'><center><font class=font-10><b class=font-vinho><br> O status foi atualizado com sucesso!<br><br></b>
</font></center></td>
</tr>
<script>window.setTimeout('changeurl();',2000); function changeurl(){window.location='index.php';}</script></table><? } ?>
...
<td width='120'><b class=font-12><span class=font-preto><center>Sigla</center></span></b></td>
</tr>
<? while ($dom = mysql_fetch_array($noticia)){ 
...
<td width='120'><font class=font-11><span class=font-cinza-1><center><? echo $dom[letra] ?></center></span></font></td>
</tr>
<? } ?>
...
<tr>
<td width='700'><center><font class=font-10><b class=font-vinho><br> Você tem certeza que desejá excluir este boleto?<br><br></b>
<form method='POST' action='status.php'>
<tr><td>
...
<?
$sql = mysql_query("DELETE FROM status WHERE id='$id' LIMIT 1;");
if (!$sql){
echo "Não foi possivel a consulta.";}
else{
?>
...
<tr>
<td width='700'><center><font class=font-10><b class=font-vinho><br> O status foi excluido com sucesso!<br><br></b>
</font></center></td>
</tr>
<script>window.setTimeout('changeurl();',2000); function changeurl(){window.location='index.php';}</script></table>
