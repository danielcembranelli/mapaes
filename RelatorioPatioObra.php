...
<body>
<p align="center"><b><font face="Verdana">Relação de Obra por Pátio<br>Pátio: <b><? echo patio($_REQUEST[Patio]);?></b>
</font></b></p>
<?
$noticia = mysql_query("SELECT * FROM `obra` WHERE `status` = 'a' AND `patio` = '".$_REQUEST[Patio]."'");
...
<?
$anoticia = mysql_query("SELECT * FROM equipamento_obra where obra = '$dom[id]' And status = 'a'");
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
  <tr>
    <td width="5%" align="center" style="border-left-width: 1; border-right-width: 1; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1"><font face="Verdana" size="1">Item</font></td>
  ...
  $i++;?>
  <tr>
    <td width="5%" align="center" style="border-left-width: 1; border-right-width: 1; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1"><font face="Verdana" size="1"><?=$i?></font></td>
    <td width="20%" align="center" style="border-left-style: solid; border-left-width: 1; border-right-width: 1; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1">
