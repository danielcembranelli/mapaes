...
<html>
<head>
<title>MAPAES: Produtividade por Pátio</title>
<meta http-equiv='content-type' content='text/html; charset=iso-8859-1'>
<link rel='StyleSheet' href='temas/include/estilos.css' type='text/css'></head>
<body>
<p align="center"><b><font face="Verdana">Produtivade por Pátio - <?=$_POST[dtInicio]?> a <?=$_POST[dtFim]?><br>
</font></b></p>
...
<table border="1" bordercolor="#666666" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td rowspan="2" align="center">Pátio</td>
    <? for($w=0;$w<count($DATA_T);$w++){?>
		<td align="center" height="20"><?=$DATA_T[$w];?></td>
    <? } ?>
    <td align="center" height="20">Média</td>
    </tr>
    <tr>
   	  <? for($w=0;$w<count($DATA_T);$w++){?>
                <td>
...
<table cellspacing="0" cellpadding="3">
	...
	<tr>
        ...
        <td>Qtda. de Equipamentos Disponíveis</td>
	</tr>
	<tr bgcolor="#FFFFDC">
   	  <td align="center">M</td>
        <td>Qtda. de Equipamentos em Manutenção</td>
	</tr>        
	<tr>
...
<p align="center"><b><font face="Verdana">Produtivade por Pátio - <?=$_POST[dtInicio]?> a <?=$_POST[dtFim]?></font></b></p>
