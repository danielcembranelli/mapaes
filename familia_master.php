...
<img src='imagens/layout_seta.gif' width="15" height="9"><b class=font-10>Adicionar família master</b><br>&nbsp;
</td>
</tr>
<form method='POST' action='familia_master.php'>
...
<?
$sql = mysql_query ("INSERT INTO familia_master (sigla,nome) VALUES ('$sigla','$nome');");
if (!$sql){
...
<?
$noticia = mysql_query("SELECT * FROM familia_master where id = '$id' order by nome");
...
$noticia = mysql_query("SELECT * FROM familia_master where statusFm='".$_REQUEST[Status]."' order by nome");
$notician = mysql_num_rows($noticia);
if (!$noticia){
?>Problemas na conexão<?
}
...
<?
$sql = mysql_query("Update familia_master set statusFm='E' WHERE id='$id' LIMIT 1;");
if (!$sql){
echo "Não foi possivel a consulta.";}
else{
?>
