...
$Sql = mysql_query("SELECT count(*) as total, dataDs FROM dip_status where ativoDs='m' and idPatio='".$_REQUEST[P]."' and dataDs='".$_REQUEST[D]."' group by dataDs;");
$t=0;
...
$insert = mysql_query("Update dip_patio set totManutencao='".$s[total]."' where idPatio='".$_REQUEST[P]."' And dtDip='".$_REQUEST[D]."' Limit 1");
}
