...
<img src='imagens/layout_seta.gif' width="15" height="9"><b class=font-10>Adicionar cliente</b><br>&nbsp;
</td>
</tr>
<form method='POST' action='cliente.php'>
<input type='hidden' name='modulo' value='criado'>
<tr>
<td width='600'><font class=font-10><span class=font-vinho>família :</span></font></td>
</tr>
<tr>
<td width='600'>
...
><tr>
<td width='600'><font class=font-10><span class=font-vinho>série/chassi :</span></font></td>
</tr>
<tr>
<td width='600'>
...
<tr>
<td width='600'><font class=font-10><span class=font-vinho>código :</span></font></td>
</tr>
<tr>
<td width='600'>
...
<tr>
<td width='600'><font class=font-10><span class=font-vinho>ano de fabricação :</span></font></td>
</tr>
<tr>
<td width='600'>
...
$sql = mysql_query ("INSERT INTO `equipamento` ( `id` , `familia` , `marca` , `modelo` , `seriechassi` , `codigo` , `ano` , `status` , `ativo`, `data` ) 
VALUES (
...
<tr>
<td width='600' validn='middle'>
<img src='imagens/layout_seta.gif' width="15" height="9"><b class=font-10>Editar operador</b><br>&nbsp;
</td>
</tr>
...
<?
$result = explode('#',$status);
$sql = mysql_query("UPDATE equipamento SET familia='$familia', marca='$marca', modelo='$modelo', seriechassi='$seriechassi', codigo='$codigo', status='$result[0]', ativo='$result[1]', ano='$ano', OBS='$OBS' WHERE id='$id' LIMIT 1;");
if (!$sql){
echo "Não foi possivel a consulta.";}
else{
?>
...
$noticia = mysql_query("SELECT * FROM equipamento where `excluido` != 's'  order by codigo,familia");
...
<td width='440'><b class=font-12><span class=font-preto><center>Código</center></span></b></td>
...
<td width='120'><font class=font-11><span class=font-cinza-1><? status($dom[status]) ?> (<? echo $dom[OBS] ?>)</span></font></td>
</tr>
<? } ?>
...
$noticia = mysql_query("SELECT * FROM equipamento where `familia` = '$familia' And `status` = '$status' And `excluido` != 's'  order by codigo,familia");
...
<tr bgcolor='#EFEFEF'>
<td width='30'><b class=font-12><center><span class=font-preto>#</span></center></b></td>
<td width='500'><b class=font-12><span class=font-preto><center>Código</center></span></b></td>
<td width='200'><b class=font-12><span class=font-preto><center>Classicação</center></span></b></td>
</tr>
<? while ($dom = mysql_fetch_array($noticia)){ 
$cor = ($coralternada++ %2 ? "FFFFFF" : "FFFFDC");
?>
<tr bgcolor='<? echo $cor ?>'>
<td width='30'><font class=font-11><span class=font-cinza-1><center><? echo $dom[id]?></center></span></font></td>
<td width='500'><font class=font-11><span class=font-cinza-1><center><? echo $dom[codigo]?> - <? familianome($dom[familia]) ?></center></span></font></td>
<td width='200'><font class=font-11><span class=font-cinza-1><center><? status($dom[status]) ?> (<? echo $dom[OBS] ?>)</center></span></font></td>
</tr>
<? if($dom[ativo]==o){?>
<tr bgcolor='<? echo $cor ?>'>
<td width='730'  colspan='4'><font class=font-11><span class=font-cinza-1><center><?
$anoticia = mysql_query("SELECT * FROM equipamento_obra where `equipamento` = '$dom[id]' order by id desc LIMIT 1");
...
if ($notician==0){
?>Nada Consta<? } else { ?><? while ($dom = mysql_fetch_array($noticia)){ ?>
			<option  value="maquina.php?modulo=localiza&id=<? echo $dom[id] ?>&status=<? echo $dom[status] ?>&codigo=<? echo $dom[codigo] ?>&familia=<? echo $dom[familia] ?>"><? echo $dom[codigo] ?></option>
			<?  } } } ?>
...
<br><font class=font-11><span class=font-azul><center>Status atual do equipamento:</span></font><? status($status) ?>  
<br><font class=font-11><span class=font-azul><center>Familia :</span></font><? fami($familia) ?></center></td>
</tr>
</table>
<?
$noticia = mysql_query("SELECT * FROM equipamento_obra where `equipamento` = '$id' order by id desc");
$notician = mysql_num_rows($noticia);
if (!$noticia){
?>Problemas na conexão<?
}
...
<tr bgcolor='<? echo $cor ?>'>
<td width='30'><font class=font-11><span class=font-cinza-1><center><? echo $dom[id]?></center></span></font></td>
<td width='560'><font class=font-11><span class=font-cinza-1>&nbsp;<? if($dom[status]==a){?><b><font color="#FF0000">Obra em andamento:</font><? } else {}?><? obranome($dom[obra]) ?> - Operador: <?if($dom[operador]==cliente){?>Cliente<? } else {?><? operador($dom[operador]) ?><? } ?><? if($dom[status]==a){?></b><? } else {}?></span></font></td>
